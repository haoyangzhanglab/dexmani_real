...
def _resolve_base_from_color(shared: "SharedStorage") -> np.ndarray:
...
def _load_static_inputs(
    ...
    while shared.is_running.value:
        ...
        base_from_color = _resolve_base_from_color(shared)
...
def pointcloud_loop(shared: "SharedStorage", config: PointCloudLoopConfig) -> None:
    ...
    shared.set_heartbeat("pointcloud", time.monotonic())
    static_inputs = _load_static_inputs(shared)
