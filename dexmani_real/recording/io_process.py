...
from dexmani_real.recording.episode_frame import decode_record_sample
from dexmani_real.recording.episode_recorder import EpisodeRecorder
from dexmani_real.recording.episode_recorder import StopResult as EpisodeStopResult
...
def _publish_status(
    ...
    *,
    ...
    reason_bytes = _bounded_control_text(
...
def _shutdown_episode_recorder(recorder: EpisodeRecorder) -> None:
    ...
    if recorder.join_stop(timeout=_RECORDER_STOP_TIMEOUT_S):
        return
