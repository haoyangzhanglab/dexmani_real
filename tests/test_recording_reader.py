"""Offline contract tests for transactional raw episode reads."""
...
class EpisodeReaderContractTest(unittest.TestCase):
    ...
    def test_read_checks_structure_without_full_video_decode(self) -> None:
